    ...
    return (
        <div className='w-full flex items-center justify-center relative h-screen overflow-y-scroll mobile:pb-32 mobile:pt-96 mobile:fixed'>
            <div className='flex items-start justify-center flex-wrap'>
                <form className='flex flex-col items-center justify-center mx-4' onSubmit={(e: FormEvent) => { e.preventDefault(); handleRegister() }}>
                ...
                <form className='flex flex-col items-center justify-center mx-4' onSubmit={(e: FormEvent) => { e.preventDefault(); handleLogin() }}>
